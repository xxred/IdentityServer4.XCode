...
{
    /// <summary></summary>
    public partial class ClientClaims : Entity<ClientClaims>
    {
        #region 对象操作
        static ClientClaims()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化ClientClaims[ClientClaims]数据……");

        //    var entity = new ClientClaims();
        //    entity.Id = 0;
        //    entity.Type = "abc";
        //    entity.Value = "abc";
        //    entity.ClientId = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化ClientClaims[ClientClaims]数据！");
        //}
        ...
        public static ClientClaims FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<ClientClaims> FindAllByClientId(Int64 clientid)
        {
            // 实体缓存
