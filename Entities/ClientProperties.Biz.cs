...
{
    /// <summary></summary>
    public partial class ClientProperties : Entity<ClientProperties>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化ClientProperties[ClientProperties]数据……");

        //    var entity = new ClientProperties();
        //    entity.Id = 0;
        //    entity.Key = "abc";
        //    entity.Value = "abc";
        //    entity.ClientId = 0;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化ClientProperties[ClientProperties]数据！");
        //}
        ...
        public static ClientProperties FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        public static IList<ClientProperties> FindAllByClientId(Int64 clientid)
        {
            // 实体缓存
