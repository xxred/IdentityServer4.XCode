...
{
    /// <summary></summary>
    public partial class IdentityResources : Entity<IdentityResources>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化IdentityResources[IdentityResources]数据……");

        //    var entity = new IdentityResources();
        //    entity.Id = 0;
        //    entity.Enabled = 0;
        //    entity.Name = "abc";
        ...
        public static IdentityResources FindById(Int32 id)
        {
            if (id <= 0) return null;
        ...
        /// <returns>实体对象</returns>
        public static IdentityResources FindByName(String name)
        {
            // 实体缓存
            if (Meta.Session.Count < 1000) return Meta.Cache.Find(e => e.Name == name);

            // 单对象缓存
            //return Meta.SingleCache.GetItemWithSlaveKey(name) as IdentityResources;

            return Find(_.Name == name);
        }

        /// <summary>根据Name查找</summary>
        /// <param name="scopeNames">Name</param>
        /// <returns>实体列表</returns>
        public static IList<IdentityResources> FindByScopeNames(String[] scopeNames)
        {
            // 实体缓存
